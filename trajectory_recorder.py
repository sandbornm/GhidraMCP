...
def analyze_trajectory(trajectory_path: str) -> dict:
    ...
    # Session info
    session_start = next((e for e in entries if e.get("type") == "session_start"), {})
    session_end = next((e for e in entries if e.get("type") == "session_end"), {})
...
def get_recorder() -> Optional[TrajectoryRecorder]:
